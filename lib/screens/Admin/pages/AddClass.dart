      ...
      children: [
                          ...
                          child: Column(
                            children: [
                              ...
                              CommonTextField(
                                ...
                                titleText:
                                    "How many streams do you want to add?",
                                padding: _padding,
              ...
              child: Container(
                child: SizedBox(
                  ...
                  child: Data_Table(
                    ...
                    rows: List.generate(
                        context.watch<MainController>().classes.length,
                        (index) {
                      debugPrint(
        ...
        Row(
          children: [
            ...
            TextButton(
              onPressed: () {
                context.read<WidgetController>().pushWidget(const StaffView());
