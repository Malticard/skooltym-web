...
Widget buildForm(){
  return  ListView(
          children: <Widget>[
           const CommonAppbarView(titleText: "Set new password",),
            Padding(
            ...
            CommonButton(
              ...
              onTap: () {
                if (_allValidation()) {
                  ...
                  Client().post(Uri.parse(AppUrls.setPassword + context.read<ForgotPasswordController>().state['id']), body: {
                      ...
                      if (value.statusCode == 200 || value.statusCode == 201) {
                        ...
                        showMessage(context: context,msg: "Password updated",type: 'success');
