...
DropOffModel dropOffModelFromJson(String str) =>
    DropOffModel.fromJson(json.decode(str));
...
class DropOffModel {
  ...
  factory DropOffModel.fromJson(Map<String, dynamic> json) => DropOffModel(
        ...
        results:
            List<DropOff>.from(json["results"].map((x) => DropOff.fromJson(x))),
      );
...
class DropOff {
  ...
  factory DropOff.fromJson(Map<String, dynamic> json) => DropOff(
        ...
        dropoffKey: List<DropoffKey>.from(
            json["dropoff_key"].map((x) => DropoffKey.fromJson(x))),
